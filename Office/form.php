...
<div id="form_container">
  ...
  <h1><a>Untitled Form</a></h1>
		<form id="form_48182" class="appnitro"  method="post" action="savecustomer.php">
					<div class="form_description">
			<h2>Walk-In Order Form</h2>
</div>						
			<ul >
		...
		<label class="description" for="element_2">* Business Identifier </label>
		<div>
...
<option value="Zimbabwe" >Zimbabwe</option>
		...
		<label class="description" for="element_4">* Delivery address </label>
...
<option value="Zimbabwe" >Zimbabwe</option>
		...
		<label class="description" for="element_5">Email Address </label>
		<div>
			<input id="element_5" name="element_5" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_6" >
		<label class="description" for="element_6">* Credit limit </label>
		<div>
			<input id="element_6" name="element_6" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_7" >
		<label class="description" for="element_7">* Type </label>
		<div>
			<input id="element_7" name="element_7" class="element text medium" type="text" maxlength="255" value=""/> 
		</div><p class="guidelines" id="guide_7"><small>Single Proprietor
Corporation</small></p> 
		</li>		<li id="li_8" >
		<label class="description" for="element_8">* Proprietor/President </label>
		<div>
			<input id="element_8" name="element_8" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_9" >
		<label class="description" for="element_9">* Line of Business </label>
		<div>
			<input id="element_9" name="element_9" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_10" >
		<label class="description" for="element_10">* COR Number </label>
		<div>
			<input id="element_10" name="element_10" class="element text medium" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_11" >
		<label class="description" for="element_11">* Contact No. </label>
		<div>
			<input id="element_11" name="element_11" class="element text medium" type="text" maxlength="255" value=""/> 
					...
					<li class="buttons">
			    <input type="hidden" name="form_id" value="48182" />
