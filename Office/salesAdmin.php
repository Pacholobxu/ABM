...
echo "<table cellspacing='0' cellpadding='2' width='98%' border=''>"; ?>
<tr bgcolor="#33FF99">

  <td valign="top" width="5%">Price</td>
  <td valign="top" width="5%">Quantity</td>
...
while($row = mysqli_fetch_array($result)) {
  ...
  </td><td><?php echo $row['Qty']; ?></td><td><?php echo $_SESSION["agentsales"]=$row['Agent_ID']; ?></td><td><?php echo $row['Item_name']; ?></td><td><?php echo $_SESSION["cus_id1"]=$row['C_id']; ?></td><td><a onclick="return confirm('Are you sure to you want APPROVE this order?)" href="appsalesAdd.php?scode=<?php echo $row['Scode']."-".$agnt."-".$row[0]."-".$row['Item_name']."-".$row['C_id']; ?>">Manage Discount</a></td></tr>
  ...
  ?><tr><td align="right"> <?php echo $_SESSION['Tsl']."<br>Total"; ?></td></tr>
