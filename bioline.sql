...
CREATE TABLE `users` (
  ...
  `ContactN` varchar(100) DEFAULT NULL,
  `ContactPerson` varchar(100) DEFAULT NULL,
  `Address` varchar(100) DEFAULT NULL,
  `AgentLevel` varchar(100) DEFAULT NULL,
  `AgentArea` varchar(100) NOT NULL,
  PRIMARY KEY (`AgentArea`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('user', 'pw', 'Ken Mhark ', '12345678910', 'Jesus', 'Ampayon', 'entry', '101');
