...
while($row = mysqli_fetch_array($result)) {
    ?><form method="post" action="valhref.php">
	<tr><td align="right"><?php echo $row[0]; ?><input type="hidden" value="<?php echo $row[0]; ?>" /><select onchange="color(this.value)" name="discount">
    <option name="choice1" value="10" >10%</option>
    <option name="choice2" value="15" >15%</option>
	 <option name="choice3" value="20" >20%</option>
    
</select></td><td><?php echo $row['Qty']; ?><input type="hidden" value="<?php echo $row['Qty']; ?>" /></td><td><?php echo $row['Agent_ID']; ?><input type="hidden" value="<?php echo $row['Agent_ID']; ?>" /></td><td><?php echo $row['Item_name']; ?><input type="hidden" value="<?php echo $row['Item_name']; ?>" /></td><td><?php echo $row['Item_code']; ?><input type="hidden" value="<?php echo $row['Item_code']; ?>" /></td><td><?php echo $row['C_id']; ?><input type="hidden" value="<?php echo $row['C_id']; ?>" /></td><td><input type="submit" value="Approve" /></td></tr></form>
	<?php
